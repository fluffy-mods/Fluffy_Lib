...
namespace FluffyLib
{
    ...
    public class DetourPropertyAttribute : Attribute
    {
        ...
        // get by name
        public DetourPropertyAttribute( Type sourceType, string sourcePropertyName, DetourProperty detourProperty = DetourProperty.Both )
        {
            sourcePropertyInfo = sourceType.GetProperty( sourcePropertyName, Detours.AllBindingFlags );
            this.detourProperty = detourProperty;
        }

        // get by propertyInfo
        public DetourPropertyAttribute( PropertyInfo sourcePropertyInfo, DetourProperty detourProperty = DetourProperty.Both )
        {
